...
$query = "SELECT p.*, c.name as category_name, c.type as category_type 
          ...
          WHERE c.type = 'coffee' AND p.is_available = 1 
          ORDER BY c.name, p.name";
$stmt = $db->prepare($query);
$stmt->execute();
$coffee_products = $stmt->fetchAll(PDO::FETCH_ASSOC);
...
<head>
    ...
    <title>منوی کافه - کافه سوخاری رامین</title>
...
<body>
    ...
    <div class="container">
        <div class="bg-image" style="background-image: url('images/coffee.jpg');"></div>
